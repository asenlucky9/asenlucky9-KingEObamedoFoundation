        ...
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-center">
          ...
          >
            <div className="relative rounded-3xl overflow-hidden shadow-2xl">
              <div className="aspect-[4/5] bg-[url('/founder/kingeobamedo.jpeg')] bg-cover bg-center relative">
          ...
          >
            ...
            <p className="text-lg text-neutral-600 mb-6 leading-relaxed">
              King E Obamedo Foundation is a dedicated non-profit organization committed to creating lasting positive change in communities across Nigeria. We focus on empowering individuals through education, skills training, employment opportunities, and community development initiatives.
            </p>
            <p className="text-base text-neutral-600 mb-8 leading-relaxed">
              Our foundation believes in the power of education, economic empowerment, and community support to transform lives and build stronger, more resilient communities.
            </p>
