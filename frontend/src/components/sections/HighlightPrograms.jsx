            ...
            return (
              ...
              >
                <Link to={`/programs/${program.id}`} className="block h-full">
                  <div className="h-full rounded-3xl overflow-hidden border-2 border-neutral-100 hover:border-accent-orange/30 transition-all duration-300 hover:shadow-2xl group-hover:-translate-y-2 bg-white">
                    {/* Content */}
                    <div className="p-6">
                      {/* Icon */}
                      ...
                      <h3 className="text-xl font-bold text-primary-navy mb-3 group-hover:text-accent-orange transition-colors leading-tight">
                        {program.title}
                      </h3>
                      ...
                      <div className="flex items-center justify-between pt-4 border-t border-neutral-100">
                        ...
                        <div className="w-10 h-10 rounded-full bg-neutral-100 group-hover:bg-accent-orange group-hover:text-white flex items-center justify-center transition-all duration-300">
